...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::Lua()
{
	...
	if (!inited)
	{
		...
		static const char* const identifiers_mw[] = {
			"enableimgui", "toclipboard", "getrawmetatable", "setreadonly", "writefile", "readfile", "appendfile", "loadfile", "newcclosure", "getthreadcontext", "getidentity",
			"setthreadcontext", "setidentity", "iscclosure", "islclosure", "isluau", "isrbxactive", "keypress", "keyrelease"
		};

		for (auto& k : identifiers_mw)
		{
			Identifier id;
			id.mDeclaration = "Moonware function";
			langDef.mIdentifiers.insert(std::make_pair(std::string(k), id));
		}
