...
#define luaL_checkstack(L, sp, junk) lua_checkstack(L, sp)
...
static int vanilla_luaL_ref( lua_State* L, int t ) {
    int ref;
    t = abs_index( L, t );
    if ( lua_isnil( L, -1 ) ) {
...
static void vanilla_luaL_unref( lua_State* L, int t, int ref ) {
    if ( ref >= 0 ) {
        t = abs_index( L, t );
        lua_rawgeti( L, t, 0 );
...
#define luaL_ref vanilla_luaL_ref

#define luaL_unref vanilla_luaL_unref
