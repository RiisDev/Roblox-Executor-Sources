...
{
	auto& if_mgr = managers::interface_manager_t::get();
...
HRESULT __stdcall present_hook( IDXGISwapChain* swap_chain, UINT sync_interval, UINT flags )
{
	...
	/* TO ADD WHEN MAKING DRAWING LIB */
...
managers::interface_manager_t& managers::interface_manager_t::get( )
{
	static interface_manager_t mgr;
