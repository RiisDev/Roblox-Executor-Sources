...
int luaD_rawrunprotected(lua_State* L, Pfunc f, void* ud)
{
    static const auto func = managers::memory_mgr.rebase<int(*)(lua_State* L, Pfunc f, void* ud)>(offsets::luaD_rawrunprotected);
...
l_noret luaD_throw(lua_State* L, int errcode)
{
    static const auto func = managers::memory_mgr.rebase<void(*)(lua_State* L, int errcode)>(offsets::lua_error);
