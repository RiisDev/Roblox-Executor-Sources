...
namespace roblox::environment::core
{
	...
	std::int32_t get_script_from_thread(lua_State* state);
	...
	std::int32_t fire_proximity_prompt(lua_State* state);
	std::int32_t set_proximity_prompt_duration(lua_State* state);
	std::int32_t get_proximity_prompt_duration(lua_State* state);

	std::int32_t get_fflag(lua_State* state);
	std::int32_t set_fflag(lua_State* state);
	...
	std::int32_t get_properties(lua_State* state);
	std::int32_t get_hidden_properties(lua_State* state);
	...
	std::int32_t is_rbx_active(lua_State* state);

	std::int32_t cloneref(lua_State* state);
	std::int32_t compareinstances(lua_State* state);

	std::int32_t require(lua_State* state);

	std::int32_t test(lua_State* state);

	std::int32_t queue_on_teleport(lua_State* state);
