	...
	{ // "Buttons" Blob
		...
		std::vector<button_t> buttons = {
			{ managers::menu_mgr.run_img, [ & ] ( )->void { 
				managers::menu_mgr.notifications.emplace_back( notification_type_t::success, "Script executed!" ); 
			} },
			{ managers::menu_mgr.trash_img, [ & ] ( )->void {
				managers::menu_mgr.editor.SetText( "" );
			} },
			{ managers::menu_mgr.files_img, [ & ] ( )->void {
				managers::menu_mgr.notifications.emplace_back( notification_type_t::success, "Copied script to clipboard!" );
			} },
			{ managers::menu_mgr.upload_img, [ & ] ( )->void {
				managers::menu_mgr.editor.SetText( "" );
				managers::menu_mgr.notifications.emplace_back( notification_type_t::success, "Pasted script from clipboard!" );
			} },
		};
