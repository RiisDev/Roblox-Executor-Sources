...
//  2018-12-03: Misc: Added #pragma comment statement to automatically link with
...
bool ImGui_ImplDX11_CreateDeviceObjects()
{
    ...
    // Create the vertex shader
    {
        ...
        if (g_pVertexShaderBlob == NULL) // NB: Pass ID3D10Blob* pErrorBlob to D3DCompile() to get error
    ...
    // Create the pixel shader
    {
        ...
        if (g_pPixelShaderBlob == NULL) // NB: Pass ID3D10Blob* pErrorBlob to D3DCompile() to get error
            // showing in (const char*)pErrorBlob->GetBufferPointer(). Make
            // sure to Release() the blob!
            return false;
