...
const char* const luaT_typenames[] = {
    ...
    vm_shuffle3(vm_shuffle_comma, "userdata",
    "number",
    "vector"),

    "string",
    
    vm_shuffle5(vm_shuffle_comma, "table",
    "function",
    "userdata",
    "thread",
    "buffer"),
...
const char* const luaT_eventname[] = {
    vm_shuffle7(vm_shuffle_comma, "__index",
    "__newindex",
    "__mode",
    "__namecall",
    "__call",
    ...
    vm_shuffle8(vm_shuffle_comma, "__add",
    "__sub",
    "__mul",
    "__div",
    "__idiv",
    ...
    vm_shuffle5(vm_shuffle_comma, "__lt",
    "__le",
    "__concat",
    "__type",
    "__metatable"),
