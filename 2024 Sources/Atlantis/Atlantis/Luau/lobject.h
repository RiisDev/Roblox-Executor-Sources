...
typedef struct Proto
{
    ...
    vm_shuffle4(vm_shuffle_semicolon, proto_member1<TValue*> k,
    proto_member1<Instruction*> code,
    proto_member1<struct Proto**> p,
    ...
    vm_shuffle5(vm_shuffle_semicolon, proto_member2<uint8_t*> lineinfo,
        proto_member2<int*> abslineinfo,
        proto_member2<struct LocVar*> locvars,
        proto_member2<TString**> upvalues,
        proto_member2<TString*> source);
   ...
   p->sizep = 168
    ...
    //a7 d a4 d a6 d a9 d a1 d a8 d a2 d a5 d a3 d a10

//#define vm_shuffle10(d, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) a4 d a5 d a9 d a8 d 

    vm_shuffle10(vm_shuffle_semicolon, 
    int sizecode,
    int sizep,
    int sizelocvars,
    int sizeupvalues,
...
typedef struct Table
{
    ...
    vm_shuffle4(vm_shuffle_semicolon, table_member<struct Table*> metatable,
        table_member<TValue*> array,
        table_member<LuaNode*> node,
    GCObject* gclist);
