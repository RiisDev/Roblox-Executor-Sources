...
namespace seliware
{
	...
	{
		//offset 23B0
        static std::int64_t luac_step = base(0x238C5B0); //11.12.2024

        static std::int64_t luau_execute = base(0x238E970); //11.12.2024

        static std::int64_t luao_nilobject = base(0x41132B8); //11.12.2024
        static std::int64_t luah_dummynode = base(0x4112A28); //11.12.2024
	}
}