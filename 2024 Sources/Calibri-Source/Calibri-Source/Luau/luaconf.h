...
static __forceinline std::int64_t base(std::int64_t address)
{
	return reinterpret_cast<std::int64_t>(GetModuleHandleA(nullptr)) + address;
}
...
namespace seliware
{
	...
	{
		//offset 23B0
		static std::int64_t luac_step = base(0x251FD20); //25.09.2024

		static std::int64_t luau_execute1 = base(0x25222B0); //25.09.2024
		static std::int64_t luau_execute2 = base(0x252CBC0); //25.09.2024

		static std::int64_t luao_nilobject = base(0x43D8E28); //25.09.2024
		static std::int64_t luah_dummynode = base(0x43D8628); //25.09.2024
	}
}