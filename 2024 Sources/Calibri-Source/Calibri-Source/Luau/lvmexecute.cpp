...
void luau_execute(lua_State* L)
{
    if (L->singlestep)
    {
        reinterpret_cast<void(__fastcall*)(lua_State*)>(seliware::address::luau_execute1)(L);
    }
    else
    {
        reinterpret_cast<void(__fastcall*)(lua_State*)>(seliware::address::luau_execute2)(L);
    }
}
#endif
