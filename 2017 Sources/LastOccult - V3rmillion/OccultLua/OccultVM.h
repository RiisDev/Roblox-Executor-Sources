...
#define OCCULT_RLUAF_CLOSE 0x545ED0 // 3

#define OCCULT_RLUAV_XORCONST 0x1A10320	//2

//55 8B EC 51 53 56 8B 75 0C 57 33 DB 8D 64 24 00 83 7E 08 07 75 66 8B 3E FF 75 10 57 E8 ? ? ? ? 
#define OCCULT_RLUAV_GETTABLE 0x54AC80 // 3

//55 8B EC 83 EC 0C 53 56 8B 75 0C 57 8B 7D 08 C7 45 ? ? ? ? ? 83 7E 08 07 0F 85 ? ? ? ? 
#define OCCULT_RLUAV_SETTABLE 0x54AEC0 // 3

//55 8B EC 51 8B 45 0C 53 83 78 08 06 56 8B 75 08 57 74 0A 50 56 E8 ? ? ? ? 83 C4 08 8B 10 8B 4E 14 
#define OCCULT_RLUAD_PRECALL 0x5457F0 // 3
#define OCCULT_RLUAD_PRECALL_RTCHECK 0x5459BD // 3

//55 8B EC 51 8B 45 10 53 56 8B F0 C1 EE 05 46 57 8B D8 8B D0 3B C6 72 26 EB 06 8D 9B 00 00 00 00
#define OCCULT_RLUAS_NEWLSTR 0x548650 // 3

//55 8B EC 53 8B 5D 08 56 8B 75 14 57 8B 7B 08 8D 43 08 56 FF 75 10 03 F8 FF 75 0C 8B 47 10 FF 77 0C 
#define OCCULT_RLUAM_REALLOC 0x547F70 // 3

//55 8B EC 6A FF 68 ? ? ? ? 64 A1 ? ? ? ? 50 64 89 25 ? ? ? ? 51 56 8B 75 08 57 8B 4E 08 
#define OCCULT_RLUA_NEWTHREAD 0x54C3A0			// 3
#define OCCULT_RLUA_NEWTHREAD_RTCHECK 0x54C400	// 3

//55 8B EC 56 8B 75 08 6A 00 6A 00 56 E8 ? ? ? ? 6A 00 6A 00 56 E8 ? ? ? ? 68 ? ? ? ?
#define OCCULT_RLUA_INITTHREAD 0x5394D0 // 3
